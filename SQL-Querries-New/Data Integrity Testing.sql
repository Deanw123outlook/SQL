/****** FixAPIFeedProvidersMappings table  ******/
SELECT [FixUnqiueID],[SourceFixID],[Source],[SourceFixName]
FROM [DatabaseName].[dbo].[FixAPIFeedProvidersMappings]
WHERE [FixUnqiueID] = xxxxxx;

/***Distinct APIFeed Provider Sources***/
SELECT DISTINCT Source FROM [DatabaseName].[dbo].[FixAPIFeedProvidersMappings]

/****** Fix Information - FixFeedMapping ******/
SELECT t1.[FixUnqiueID],t6.[SourceFixID],t4.[Name] AS "HT",t4.[TUniqueID],t5.[Name] AS "AT",t5.[TUniqueID],t6.[SourceFixName], t1.[LeagueUniqueID],t2.[MasterAPIFeedProvSource],t6.[Source] AS "FixAPIFeedProvidersMappingsSourceReference", t2.[EndDate] AS [LeagueEndDate],t2.[CompId],t3.[Name] AS "CompsName",t2.[Active] AS [LeagueActive],t1.[TimestampUTC],t1.[APIFeedID],
...
FULL OUTER JOIN [DatabaseName].[dbo].[FixAPIFeedProvidersMappings] AS t6 ON t1.[FixUnqiueID] = t6.[FixUnqiueID]
