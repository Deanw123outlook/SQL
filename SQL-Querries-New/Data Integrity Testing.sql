...
WHERE t1.[StartTimeUTC] BETWEEN '2023-10-20 00:00:00.000' AND '2023-10-22 00:00:00.000' AND t1.[LeagueUniqueID] = 900 AND t1.[FixUnqiueID] = xxxxxx ORDER BY t1.[StartTimeUTC];
...
FULL OUTER JOIN [DatabaseName].[dbo].[Teams] AS t5 ON t1.AwayTUniqueID = t5.TUniqueID 
FULL OUTER JOIN [DatabaseName].[dbo].[FixAPIFeedProvidesMappings] AS t6 ON t1.[FixUnqiueID] = t6.[FixUnqiueID]
WHERE t1.[StartTimeUTC] BETWEEN '2023-11-20 00:00:00.000' AND '2023-11-26 00:00:00.000' AND t1.[LeagueUniqueID] = 900 ORDER BY t1.[StartTimeUTC];
...
FULL OUTER JOIN [DatabaseName].[dbo].[Teams] AS t5 ON t1.AwayTUniqueID = t5.TUniqueID 
FULL OUTER JOIN [DatabaseName].[dbo].[FixAPIFeedProvidesMappings] AS t6 ON t1.[FixUnqiueID] = t6.[FixUnqiueID]
WHERE t1.[StartTimeUTC] BETWEEN '2023-10-20 00:00:00.000' AND '2023-10-22 00:00:00.000' AND t1.[LeagueUniqueID] = 900 AND t6.[Source] = 12 ORDER BY t1.[StartTimeUTC];