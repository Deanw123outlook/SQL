...
SELECT t1.[FixtureId],t4.[Name] AS "HomeTeam",t4.[TeamId],t5.[Name] AS "AwayTeam",t5.[TeamId], t1.[LeagueId],t2.[Source], t2.[EndDate] AS [LeagueEndDate],t2.[CompeID],t3.[Name] AS "CompetitionName",t2.[Active] AS [CompetitonLeagueActive],t1.[StartTimeUTC],t1.[FeedId],
t1.[Settled],t1.[DisableSchedueledStartTimeUpdates]
...
WHERE t1.[StartTimeUTC] BETWEEN '2023-09-20 00:00:00.000' AND '2023-09-22 00:00:00.000' AND t1.[LeagueId] = 'xxx';

/****** Fixture & ExternalFixtureId Data  ******/
SELECT t1.[ClientId], t7.[Name],t1.[FixtureId],t4.[Name] AS [HomeTeam],t5.[Name] AS [AwayTeam],t1.[ExternalFixtureId],t3.[LeagueId],t3.[CompeID],t6.[Name] AS [Competition-Name], t2.[StartTimeUTC]
...
SELECT t1.[FixtureId],t4.[Name] AS [HomeTeam],t5.[Name] AS [AwayTeam],t2.[StartTimeUTC],t1.[ServiceProviderFixtureId],t3.[LeagueId],t3.[CompeID],t6.[Name] AS [Competition-Name]
